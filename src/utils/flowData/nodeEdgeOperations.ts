...
import { hasNetworkNode } from './nodeCreation';
...
export const createDuplicatedNodes = (
  ...
  if (
    ...
    hasNetworkNode(existingNodes)
  ) {
    toast.error("Cannot duplicate Network node", {
      description: "Only one Network node is allowed"
    });
    return null;
  }
